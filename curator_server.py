...
# ─────────────────────────────────────────────────────────────────────────────
# Research Intelligence — observation endpoint
# ─────────────────────────────────────────────────────────────────────────────

RESEARCH_ROOT = BASE_DIR / '_NewDomains' / 'research-intelligence'

@app.route('/research/observe')
def research_observe_ui():
    """Serve the observation trigger HTML page."""
    observe_html = RESEARCH_ROOT / 'web' / 'observe.html'
    if not observe_html.exists():
        return "observe.html not found", 404
    return observe_html.read_text(), 200, {'Content-Type': 'text/html'}

@app.route('/api/research/observe', methods=['POST'])
...
# ─────────────────────────────────────────────────────────────────────────────
# Research: Candidates UI
# ─────────────────────────────────────────────────────────────────────────────

@app.route('/research/candidates')
...
@app.route('/api/research/candidates')
...
@app.route('/api/research/candidates/promote', methods=['POST'])
...
@app.route('/api/research/candidates/retire', methods=['POST'])
